    ...
    return (
        <AnimatePresence mode="wait">
            <div key={'00'}>
                        ...
                        <Section>
                            <div className={styles.content}>
                                ...
                                <p className={styles.info}>
                                    <span style={{ color: '#fff', fontWeight: 'bold' }}>Arbitrage</span> involves exploiting price differences of the sameasset in different markets or ondifferent platforms. For example, if an asset ispriced lower on one exchange and higher onanother, traders can buy the asset on thecheaper platform and sell it on the moreexpensive one, profiting from the price differential. Arbitrage opportunities are often fleeting and require quick execution tocapitalize on the price gaps.
                                </p>
                            </div>
                        </Section>
                    </div>
                    <div className={styles.container}>
                        <Section>
                            <div className={styles.content}>
                                ...
                                <p className={styles.info}>
                                    <span style={{ color: '#fff', fontWeight: 'bold' }}>Flash loans </span>are a relatively new form of uncollateralized loans available to traders on some decentralized finance (DeFi) protocols based on a blockchain networks.
                                    This type of loan allows traders to borrow unsecured loans from lenders without intermediaries.
                                </p>
                            </div>
                        </Section>
                        <div>
                            <Image className={styles.rat} width={404} height={585} alt='boome' src={'/home/block2_rat1.png'} />
                        </div>
                    </div>
                </div>
                <div className={styles.block3}>
                    <div className={styles.bg}>
                        ...
                        <div className={styles.memeRight}>
                            <Image className={styles.img} width={542} height={175} alt='boome' src={'/home/block3_bg3.png'} />
                        </div>
                        <div className={styles.memeRight}>
                            <Image className={styles.img} width={542} height={175} alt='boome' src={'/home/block3_bg3.png'} />
                        </div>
                        ...
                        <div className={styles.bottom}>
                            <Image className={styles.img} width={1921} height={1280} alt='boome' src={'/home/block3_bg2.png'} />
                        </div>
                    </div>
                    <div className={styles.container} style={{ maxWidth: '1000px', marginTop: '130px', zIndex: 1000 }}>
                        <Section>
                            <div className={styles.bar} style={{ zIndex: 1000 }}>
                                <div className={styles.quota}>
                                    <Image className={styles.quotaImg} width={34} height={22} alt='boome' src={'/home/block2_quota1.png'} />
                                </div>
                                ...
                                <div className={styles.quota} style={{ zIndex: 1000 }}>
                                    <Image className={styles.quotaImg} width={34} height={22} alt='boome' src={'/home/block2_quota2.png'} />
                                </div>
                    ...
                    <div className={styles.title} style={{ zIndex: 1000, position: 'relative' }}>
                        <div>
                            FLASH LOAN
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.arrow}>
                            <Image className={styles.arrowImg} width={61} height={54} alt='boome' src={'/home/block3_arrow.png'} />
                        </div>
                        <div className={styles.item}>
                ...
                <div className={styles.block4}>
                    <p className={styles.title}>
                        CHALLENGES IN
                        <span style={{ color: '#00F600', zIndex: 1000 }}> ARBITRAGE & FLASH LOANS</span>
                    </p>
                    ...
                    <p className={styles.title} style={{ width: '1000px', marginTop: '200px' }}>
                        <Image width={1199} height={183} alt='boome' src={'/home/block4_bottom.png'} style={{ width: '100%', height: 'auto' }} />
                    </p>
                </div>
            </div>
                ...
                <div className={styles.container}>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={95} height={95} alt='boome' src={'/home/block5_logo1.png'} />
                        </div>
                        <div className={styles.cardInfo}>Zero collateral loans - every user of Boomerang can receive loan for transaction</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={84} height={95} alt='boome' src={'/home/block5_logo2.png'} />
                        </div>
                        <div className={styles.cardInfo}>Al scans available DEXs and will present the best available trade options</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={105} height={82} alt='boome' src={'/home/block5_logo3.png'} />
                        </div>
                        <div className={styles.cardInfo}>No need to have experience or knowledge with trading bots to be successful trader</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={81} height={95} alt='boome' src={'/home/block5_logo4.png'} />
                        </div>
                        <div className={styles.cardInfo}>Al presents only profitable trades - there is no option to exescute trade with loss</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={93} height={76} alt='boome' src={'/home/block5_logo5.png'} />
                        </div>
                        <div className={styles.cardInfo}>Seamless user interface</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={105} height={92} alt='boome' src={'/home/block5_logo6.png'} />
                        </div>
                        <div className={styles.cardInfo}>No need to have experience or knowledge with trading bots to be successful trader</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={95} height={95} alt='boome' src={'/home/block5_logo7.png'} />
                        </div>
                        <div className={styles.cardInfo}>Aggregated flash loanslending</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={94} height={91} alt='boome' src={'/home/block5_logo8.png'} />
                        </div>
                        <div className={styles.cardInfo}>Aggregated DEX marketplace</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                            <Image className={styles.cardImg} width={112} height={95} alt='boome' src={'/home/block5_logo9.png'} />
                        </div>
            ...
            <div className={styles.block6}>
                ...
                <div className={styles.content}>
                    <Image className={styles.contentImg} width={1337} height={855} alt='boome' src={'/home/block6_map.png'} />
                </div>
                ...
                <div className={styles.container}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo1.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo2.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo3.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo4.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo5.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo6.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo7.png'} />
                        </div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardTitle}>
                        ...
                        <div className={styles.cardLogo}>
                            <Image className={styles.logo} width={70} height={70} alt='boome' src={'/home/block6_logo8.png'} />
                        </div>
                    </div>
                </div>
            </div>
            <div className={styles.block7}>
                <p className={styles.title} style={{ marginTop: '0px' }}>
                    FLASH LOAN
                    <span style={{ color: '#00F600', zIndex: 1000 }}> LENDING PROTOCOL</span>
                </p>
                <div className={styles.container}>
                    <div className={styles.card}>
                        <Image className={styles.logo} width={70} height={70} src={'/home/block7_logo1.png'} alt='' />
                        <div className={styles.cardInfo}>AAVE</div>
                    </div>
                    <div className={styles.card}>
                        <Image className={styles.logo} width={70} height={70} src={'/home/block7_logo2.png'} alt='' />
                        <div className={styles.cardInfo}>RADIANT</div>
                    </div>
                    <div className={styles.card}>
                        <Image className={styles.logo} width={70} height={70} src={'/home/block7_logo3.png'} alt='' />
                        <div className={styles.cardInfo}>DYDX</div>
                    </div>
                    <div className={styles.card}>
                        <Image className={styles.logo} width={70} height={70} src={'/home/block7_logo4.png'} alt='' />
                ...
                <div className={styles.container}>
                    {
                        block8_list.map((item, index) => (
                            <div className={styles.card} key={index}>
                                <Image className={styles.logo} width={70} height={70} src={item.img} alt='' />
            ...
            <div className={styles.block10} style={{ marginTop: '100px' }}>
                <p className={styles.title} style={{ marginTop: '0px' }}>
                    DECENTRALIZED
                    <span style={{ color: '#00F600', zIndex: 1000 }}> EXCHANGES AGGRAGATORS</span>
                </p>
                <div className={styles.container}>
                    {
            ...
            <div className={styles.block11} style={{ marginTop: '100px' }}>
                ...
                <div className={styles.container}>
                    <Image className={styles.content} width={1727} height={1140} src={'/home/block11_content.png'} alt='' />
                </div>
                <div className={styles.container2}>
                    ...
                    <Section>
                        <div className={styles.content}>
                            ...
                            <p className={styles.info}>
                                <span style={{ color: '#fff', fontWeight: 'bold' }}>BOOMERANG </span>
                                prepares profitable trades and keeping the execution of arbitrage trades fortrader. Smart contracts lock in the trade parameters, ensure timely execution, and facilitatethe movement of assets between different markets or platforms.
                                By using smart contracts and Al, MoWGLl protocol can achieve a high degree ofautomation, transparency, and reliability in executing arbitrage trades without the need for manual coding and analyzing
                            </p>
                        </div>
                    </Section>
                </div>
            ...
            <div className={styles.block12}>
                <div className={styles.bg}>
                    ...
                    <div className={styles.meme}>
                        <Image className={styles.img} width={1920} height={333} alt='boome' src={'/home/block6_bg_top.png'} />
                    </div>
                    <div className={styles.meme2}>
                        <Image className={styles.img} width={1920} height={1171} alt='boome' src={'/home/block13_bg_big.png'} />
                    </div>
                    {/* <div className={styles.memeLeft}>
                        <Image className={styles.img} width={542} height={175} alt='boome' src={'/home/block3_meme2.png'} />
                    </div> */}
                ...
                <p className={styles.title} style={{ marginTop: '0px' }}>
                    YOUR
                    <span style={{ color: '#00F600', zIndex: 1000 }}> SUCCESS TRADES</span>
                </p>
                <div className={styles.container}>
                    <div className={styles.item}>
                    ...
                    <div className={styles.item}>
                        There is no risk of losing money should a sequence of trades not execute as expected;
                        the transactions will be reverted due to lack of funds, because the smart contract isn'table to repay a flash loan or before others do.
                    </div>
                    <div className={styles.item}>
                        It does not require any kind of prediction algorithm or stop-loss strategy, but rather itdeals with finding profitable opportunities in the present moment before they disappear.
                    </div>
                </div>
            </div>
